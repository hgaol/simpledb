...
public class QueryTest {
    ...
    /**
     * hgao: 修改simpledb.systemtest.SystemTestUtil#MAX_RAND_VALUE可以改变最大值范围，如果太大则一般结果为0rows
     */
    @Test(timeout = 20000)
    public void queryTest() throws IOException, DbException, TransactionAbortedException {
        ...
        String query = "SELECT * FROM dept,hobbies,hobby,emp WHERE hobbies.c0 = emp.c2 AND emp.c1 = dept.c0 AND hobbies.c1 = hobby.c0 AND emp.c3 < 1000;";
        System.out.println("Query: " + query);
        p.processNextStatement(query);
    }
}
